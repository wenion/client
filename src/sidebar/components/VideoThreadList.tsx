...
import VideoThreadCard from './VideoThreadCard';
 ...
 */
export default function VideoThreadList({ threads }: ThreadListProps) {
  ...
  const newAnnotationTag = (() => {
    ...
    const newAnnotations = store.unsavedVideoAnnotations();
