...
import AnnotationHeader from './VideoAnnotation/AnnotationHeader';
import VideoEmptyAnnotation from './VideoAnnotation/VideoEmptyAnnotation';
 ...
 * collapsible.
 */
function VideoThread({ thread, threadsService }: ThreadProps) {
  ...
  const isEditing =
    thread.annotation && !!store.getVideoDraft(thread.annotation) && !isSaving;
        ...
        {!thread.collapsed && (
          ...
          >
            {visibleChildren.map(child => (
              ...
              >
                <VideoThread thread={child} threadsService={threadsService} />
              </li>
            ))}
          </ul>
        )}
...
export default withServices(VideoThread, ['threadsService']);
