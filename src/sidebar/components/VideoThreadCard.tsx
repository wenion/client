 ...
 */
function VideoThreadCard({ frameSync, thread }: ThreadCardProps) {
  ...
  const threadContent = useMemo(() => <VideoThread thread={thread} />, [thread]);
...
export default withServices(VideoThreadCard, ['frameSync']);
