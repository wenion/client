...
import { isMessageEqual } from '../../shared/messaging/port-util';

/** Timeout for waiting for the host frame to respond to a port request. */
export const MAX_WAIT_FOR_PORT = 1000 * 60;
 ...
 * @typedef {import('../../shared/messaging/port-util').Message} Message
 * @typedef {import('../../shared/messaging/port-util').Frame} Frame
 */
